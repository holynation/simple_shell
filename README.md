# This is an implementation of sh using C programming language

## Overview

**Simple Shell** - is a Alx school group project. The task is to write a simple UNIX command interpreter.
